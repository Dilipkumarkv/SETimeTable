    ...
    html += `
      ...
      <div class="workload-stats-card">
        <div class="workload-stats-header">
          <strong>Weekly Workload: ${lecturerWeek.lecturerName && lecturerWeek.lecturerName !== lecturerWeek.initials ? `${lecturerWeek.lecturerName} (${lecturerWeek.initials})` : lecturerWeek.initials}</strong>
        </div>
